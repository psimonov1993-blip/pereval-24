...
(function (root) {
  ...
  var TERMS_EXECUTOR = [
    ...
    'Нормативное время на погрузку составляет 2 часа, на выгрузку 2 часа, при наличии соответствующих отметок в транспортной накладной. При превышении суммарного норматива в 4 часа Заказчик оплачивает Исполнителю простой из расчёта 1500 рублей за каждый час простоя сверх норматива.',
